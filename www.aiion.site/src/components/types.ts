...
export type HealthView = 'home' | 'health' | 'exercise' | 'exercise-detail' | 'exercise-recommendation' | 'exercise-stretching' | 'exercise-weight-loss' | 'exercise-weight' | 'exercise-sports' | 'medication' | 'sleep' | 'nutrition' | 'records' | 'scan';
